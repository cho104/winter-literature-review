document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleMove(url, targetFolderName) {
        // Basic frontend check. Backend handles strict duplicate checks.
        queueAction({ type: 'move', url: url, target: targetFolderName });
        alert(`Move queued! Sync to finalize.`);
    }
    ...
    function handleDelete(url) {
        ...
        viewerPanel.innerHTML = '<div class="empty-state"><p>Deleted.</p></div>';
    }
